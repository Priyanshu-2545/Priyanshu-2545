...
![AWS CloudWatch](https://img.shields.io/badge/CloudWatch-FF9900?style=for-the-badge&logo=amazon-aws&logoColor=white)
...
%%{init: {'theme':'dark', 'themeVariables': { 
  ...
  'primaryBorderColor':'#302b63', 
  'lineColor':'#00d4ff', 
  'secondaryColor':'#302b63', 
  'tertiaryColor':'#0f0c29'
}}}%%
mindmap
  root((Priyanshu's Stack))
    DevOps Core
      CI/CD Pipelines
      Docker & Kubernetes
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=venom&color=0:24243e,50:302b63,100:0f0c29&height=80&section=footer" />
